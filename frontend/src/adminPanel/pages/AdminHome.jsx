    ...
    <ul className="metismenu" id="menu">
      <li>
        <a href="javascript:;" className="has-arrow">
          <div className="parent-icon"><i className="bx bx-home-alt" />
          </div>
          <div className="menu-title">Dashboard</div>
        </a>
        <ul>
          <li> <a href="index.html"><i className="bx bx-radio-circle" />Default</a>
          </li>
          <li> <a href="index2.html"><i className="bx bx-radio-circle" />Alternate</a>
          </li>
          <li> <a href="index3.html"><i className="bx bx-radio-circle" />Graphical</a>
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li> <a href="app-emailbox.html"><i className="bx bx-radio-circle" />Email</a>
          </li>
          <li> <a href="app-chat-box.html"><i className="bx bx-radio-circle" />Chat Box</a>
          </li>
          <li> <a href="app-file-manager.html"><i className="bx bx-radio-circle" />File Manager</a>
          </li>
          <li> <a href="app-contact-list.html"><i className="bx bx-radio-circle" />Contatcs</a>
          </li>
          <li> <a href="app-to-do.html"><i className="bx bx-radio-circle" />Todo List</a>
          </li>
          <li> <a href="app-invoice.html"><i className="bx bx-radio-circle" />Invoice</a>
          </li>
          <li> <a href="app-fullcalender.html"><i className="bx bx-radio-circle" />Calendar</a>
          </li>
        </ul>
      </li>
      ...
      <li>
        <a href="widgets.html">
          <div className="parent-icon"><i className="bx bx-cookie" />
          </div>
      ...
      <li>
        ...
        <ul>
          <li> <a href="ecommerce-products.html"><i className="bx bx-radio-circle" />Products</a>
          </li>
          <li> <a href="ecommerce-products-details.html"><i className="bx bx-radio-circle" />Product Details</a>
          </li>
          <li> <a href="ecommerce-add-new-products.html"><i className="bx bx-radio-circle" />Add New Products</a>
          </li>
          <li> <a href="ecommerce-orders.html"><i className="bx bx-radio-circle" />Orders</a>
          </li>
        </ul>
      </li>
      <li>
        <a className="has-arrow" href="javascript:;">
          <div className="parent-icon"><i className="bx bx-bookmark-heart" />
          </div>
          <div className="menu-title">Components</div>
        </a>
        <ul>
          <li> <a href="component-alerts.html"><i className="bx bx-radio-circle" />Alerts</a>
          </li>
          <li> <a href="component-accordions.html"><i className="bx bx-radio-circle" />Accordions</a>
          </li>
          <li> <a href="component-badges.html"><i className="bx bx-radio-circle" />Badges</a>
          </li>
          <li> <a href="component-buttons.html"><i className="bx bx-radio-circle" />Buttons</a>
          </li>
          <li> <a href="component-cards.html"><i className="bx bx-radio-circle" />Cards</a>
          </li>
          <li> <a href="component-carousels.html"><i className="bx bx-radio-circle" />Carousels</a>
          </li>
          <li> <a href="component-list-groups.html"><i className="bx bx-radio-circle" />List Groups</a>
          </li>
          <li> <a href="component-media-object.html"><i className="bx bx-radio-circle" />Media Objects</a>
          </li>
          <li> <a href="component-modals.html"><i className="bx bx-radio-circle" />Modals</a>
          </li>
          <li> <a href="component-navs-tabs.html"><i className="bx bx-radio-circle" />Navs &amp; Tabs</a>
          </li>
          <li> <a href="component-navbar.html"><i className="bx bx-radio-circle" />Navbar</a>
          </li>
          <li> <a href="component-paginations.html"><i className="bx bx-radio-circle" />Pagination</a>
          </li>
          <li> <a href="component-popovers-tooltips.html"><i className="bx bx-radio-circle" />Popovers &amp; Tooltips</a>
          </li>
          <li> <a href="component-progress-bars.html"><i className="bx bx-radio-circle" />Progress</a>
          </li>
          <li> <a href="component-spinners.html"><i className="bx bx-radio-circle" />Spinners</a>
          </li>
          <li> <a href="component-notifications.html"><i className="bx bx-radio-circle" />Notifications</a>
          </li>
          <li> <a href="component-avtars-chips.html"><i className="bx bx-radio-circle" />Avatrs &amp; Chips</a>
          </li>
        </ul>
      </li>
      <li>
        <a className="has-arrow" href="javascript:;">
          <div className="parent-icon"><i className="bx bx-repeat" />
          </div>
          <div className="menu-title">Content</div>
        </a>
        <ul>
          <li> <a href="content-grid-system.html"><i className="bx bx-radio-circle" />Grid System</a>
          </li>
          <li> <a href="content-typography.html"><i className="bx bx-radio-circle" />Typography</a>
          </li>
          <li> <a href="content-text-utilities.html"><i className="bx bx-radio-circle" />Text Utilities</a>
          </li>
        </ul>
      </li>
      <li>
        <a className="has-arrow" href="javascript:;">
          <div className="parent-icon"> <i className="bx bx-donate-blood" />
          </div>
          <div className="menu-title">Icons</div>
        </a>
        <ul>
          <li> <a href="icons-line-icons.html"><i className="bx bx-radio-circle" />Line Icons</a>
          </li>
          <li> <a href="icons-boxicons.html"><i className="bx bx-radio-circle" />Boxicons</a>
          </li>
          <li> <a href="icons-feather-icons.html"><i className="bx bx-radio-circle" />Feather Icons</a>
          </li>
        </ul>
      </li>
      <li>
        <a href="form-froala-editor.html">
          <div className="parent-icon"><i className="bx bx-code-alt" />
          </div>
      ...
      <li>
        <a className="has-arrow" href="javascript:;">
          <div className="parent-icon"><i className="bx bx-message-square-edit" />
          </div>
          <div className="menu-title">Forms</div>
        </a>
        <ul>
          <li> <a href="form-elements.html"><i className="bx bx-radio-circle" />Form Elements</a>
          </li>
          <li> <a href="form-input-group.html"><i className="bx bx-radio-circle" />Input Groups</a>
          </li>
          <li> <a href="form-radios-and-checkboxes.html"><i className="bx bx-radio-circle" />Radios &amp; Checkboxes</a>
          </li>
          <li> <a href="form-layouts.html"><i className="bx bx-radio-circle" />Forms Layouts</a>
          </li>
          <li> <a href="form-validations.html"><i className="bx bx-radio-circle" />Form Validation</a>
          </li>
          <li> <a href="form-wizard.html"><i className="bx bx-radio-circle" />Form Wizard</a>
          </li>
          <li> <a href="form-text-editor.html"><i className="bx bx-radio-circle" />Text Editor</a>
          </li>
          <li> <a href="form-file-upload.html"><i className="bx bx-radio-circle" />File Upload</a>
          </li>
          <li> <a href="form-date-time-pickes.html"><i className="bx bx-radio-circle" />Date Pickers</a>
          </li>
          <li> <a href="form-select2.html"><i className="bx bx-radio-circle" />Select2</a>
          </li>
          <li> <a href="form-repeater.html"><i className="bx bx-radio-circle" />Form Repeater</a>
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li> <a href="table-basic-table.html"><i className="bx bx-radio-circle" />Basic Table</a>
          </li>
          <li> <a href="table-datatable.html"><i className="bx bx-radio-circle" />Data Table</a>
          </li>
        </ul>
      </li>
      ...
      <li>
        <a className="has-arrow" href="javascript:;">
          <div className="parent-icon"><i className="bx bx-lock" />
          </div>
          <div className="menu-title">Authentication</div>
        </a>
        <ul>
          <li><a className="has-arrow" href="javascript:;"><i className="bx bx-radio-circle" />Basic</a>
            <ul>
              <li><a href="auth-basic-signin.html" target="_blank"><i className="bx bx-radio-circle" />Sign In</a></li>
              <li><a href="auth-basic-signup.html" target="_blank"><i className="bx bx-radio-circle" />Sign Up</a></li>
              <li><a href="auth-basic-forgot-password.html" target="_blank"><i className="bx bx-radio-circle" />Forgot Password</a></li>
              <li><a href="auth-basic-reset-password.html" target="_blank"><i className="bx bx-radio-circle" />Reset Password</a></li>
            </ul>
          </li>
          <li><a className="has-arrow" href="javascript:;"><i className="bx bx-radio-circle" />Cover</a>
            <ul>
              <li><a href="auth-cover-signin.html" target="_blank"><i className="bx bx-radio-circle" />Sign In</a></li>
              <li><a href="auth-cover-signup.html" target="_blank"><i className="bx bx-radio-circle" />Sign Up</a></li>
              <li><a href="auth-cover-forgot-password.html" target="_blank"><i className="bx bx-radio-circle" />Forgot Password</a></li>
              <li><a href="auth-cover-reset-password.html" target="_blank"><i className="bx bx-radio-circle" />Reset Password</a></li>
            </ul>
          </li>
          <li><a className="has-arrow" href="javascript:;"><i className="bx bx-radio-circle" />With Header Footer</a>
            <ul>
              <li><a href="auth-header-footer-signin.html" target="_blank"><i className="bx bx-radio-circle" />Sign In</a></li>
              <li><a href="auth-header-footer-signup.html" target="_blank"><i className="bx bx-radio-circle" />Sign Up</a></li>
              <li><a href="auth-header-footer-forgot-password.html" target="_blank"><i className="bx bx-radio-circle" />Forgot Password</a></li>
              <li><a href="auth-header-footer-reset-password.html" target="_blank"><i className="bx bx-radio-circle" />Reset Password</a></li>
            </ul>
          </li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul>
          <li> <a href="errors-404-error.html" target="_blank"><i className="bx bx-radio-circle" />404 Error</a>
          </li>
          <li> <a href="errors-500-error.html" target="_blank"><i className="bx bx-radio-circle" />500 Error</a>
          </li>
          <li> <a href="errors-coming-soon.html" target="_blank"><i className="bx bx-radio-circle" />Coming Soon</a>
          </li>
          <li> <a href="error-blank-page.html" target="_blank"><i className="bx bx-radio-circle" />Blank Page</a>
          </li>
        </ul>
      </li>
      <li>
      ...
      <li>
        <a href="pricing-table.html">
          <div className="parent-icon"><i className="bx bx-diamond" />
          </div>
      ...
      <li>
        ...
        <ul>
          <li> <a href="charts-apex-chart.html"><i className="bx bx-radio-circle" />Apex</a>
          </li>
          <li> <a href="charts-chartjs.html"><i className="bx bx-radio-circle" />Chartjs</a>
          </li>
          <li> <a href="charts-highcharts.html"><i className="bx bx-radio-circle" />Highcharts</a>
          </li>
        </ul>
      </li>
      <li>
        <a className="has-arrow" href="javascript:;">
          <div className="parent-icon"><i className="bx bx-map-alt" />
          </div>
          <div className="menu-title">Maps</div>
        </a>
        <ul>
          <li> <a href="map-google-maps.html"><i className="bx bx-radio-circle" />Google Maps</a>
          </li>
          <li> <a href="map-vector-maps.html"><i className="bx bx-radio-circle" />Vector Maps</a>
          </li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul>
          <li> <a className="has-arrow" href="javascript:;"><i className="bx bx-radio-circle" />Level One</a>
            <ul>
              <li> <a className="has-arrow" href="javascript:;"><i className="bx bx-radio-circle" />Level Two</a>
                <ul>
                  <li> <a href="javascript:;"><i className="bx bx-radio-circle" />Level Three</a>
                  </li>
                </ul>
              </li>
            </ul>
      ...
      <li>
        <a href="https://codervent.com/rocker/documentation/index.html" target="_blank">
          <div className="parent-icon"><i className="bx bx-folder" />
          </div>
    ...
    <div className="topbar d-flex align-items-center">
      <nav className="navbar navbar-expand gap-3">
        ...
        <div className="position-relative search-bar d-lg-block d-none" data-bs-toggle="modal" data-bs-target="#SearchModal">
          <input className="form-control px-5" disabled type="search" placeholder="Search" />
          <span className="position-absolute top-50 search-show ms-3 translate-middle-y start-0 top-50 fs-5"><i className="bx bx-search" /></span>
        </div>
        <div className="top-menu ms-auto">
          <ul className="navbar-nav align-items-center gap-1">
            <li className="nav-item mobile-search-icon d-flex d-lg-none" data-bs-toggle="modal" data-bs-target="#SearchModal">
              <a className="nav-link" href="avascript:;"><i className="bx bx-search" />
              </a>
            </li>
            ...
            <li className="nav-item dark-mode d-none d-sm-flex">
              <a className="nav-link dark-mode-icon" href="javascript:;"><i className="bx bx-moon" />
              </a>
            </li>
            <li className="nav-item dropdown dropdown-app">
              <a className="nav-link dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown" href="javascript:;"><i className="bx bx-grid-alt" /></a>
                ...
                <div className="header-message-list">
                  <a className="dropdown-item" href="javascript:;">
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <div className="cart-product-cancel"><i className="bx bx-x" />
                      </div>
                    </div>
                  </a>
                  <a className="dropdown-item" href="javascript:;">
        ...
        <div className="user-box dropdown px-3">
          ...
          <ul className="dropdown-menu dropdown-menu-end">
            <li><a className="dropdown-item d-flex align-items-center" href="javascript:;"><i className="bx bx-user fs-5" /><span>Profile</span></a>
            </li>
            <li><a className="dropdown-item d-flex align-items-center" href="javascript:;"><i className="bx bx-cog fs-5" /><span>Settings</span></a>
            </li>
            <li><a className="dropdown-item d-flex align-items-center" href="javascript:;"><i className="bx bx-home-circle fs-5" /><span>Dashboard</span></a>
            </li>
            <li><a className="dropdown-item d-flex align-items-center" href="javascript:;"><i className="bx bx-dollar-circle fs-5" /><span>Earnings</span></a>
            </li>
            <li><a className="dropdown-item d-flex align-items-center" href="javascript:;"><i className="bx bx-download fs-5" /><span>Downloads</span></a>
            </li>
            <li>
              <div className="dropdown-divider mb-0" />
            </li>
            <li><a className="dropdown-item d-flex align-items-center" href="javascript:;"><i className="bx bx-log-out-circle" /><span>Logout</span></a>
            </li>
          </ul>
        </div>
      </nav>
          ...
          <div className="card radius-10 border-start border-0 border-4 border-info">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div className="widgets-icons-2 rounded-circle bg-gradient-blues text-white ms-auto"><i className="bx bxs-cart" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card radius-10 border-start border-0 border-4 border-danger">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div className="widgets-icons-2 rounded-circle bg-gradient-burning text-white ms-auto"><i className="bx bxs-wallet" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card radius-10 border-start border-0 border-4 border-success">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div className="widgets-icons-2 rounded-circle bg-gradient-ohhappiness text-white ms-auto"><i className="bx bxs-bar-chart-alt-2" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card radius-10 border-start border-0 border-4 border-warning">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div className="widgets-icons-2 rounded-circle bg-gradient-orange text-white ms-auto"><i className="bx bxs-group" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="table-responsive">
            <table className="table align-middle mb-0">
              ...
              <tbody><tr>
                  ...
                  <td>$1250.00</td>
                  <td>03 Feb 2020</td>
                  <td><div className="progress" style={{height: 6}}>
            ...
            <div className="card-body">
              <div className="row">
                ...
                <div className="col-lg-5 col-xl-4">
                  <div className="mb-4">
                    <p className="mb-2"><i className="flag-icon flag-icon-us me-1" /> USA <span className="float-end">70%</span></p>
                    <div className="progress" style={{height: 7}}>
                      <div className="progress-bar bg-primary progress-bar-striped" role="progressbar" style={{width: '70%'}} />
                    </div>
                  </div>
                  <div className="mb-4">
                    <p className="mb-2"><i className="flag-icon flag-icon-ca me-1" /> Canada <span className="float-end">65%</span></p>
                    <div className="progress" style={{height: 7}}>
                      <div className="progress-bar bg-danger progress-bar-striped" role="progressbar" style={{width: '65%'}} />
                    </div>
                  </div>
                  <div className="mb-4">
                    <p className="mb-2"><i className="flag-icon flag-icon-gb me-1" /> England <span className="float-end">60%</span></p>
                    <div className="progress" style={{height: 7}}>
                      <div className="progress-bar bg-success progress-bar-striped" role="progressbar" style={{width: '60%'}} />
                    </div>
                  </div>
                  <div className="mb-4">
                    <p className="mb-2"><i className="flag-icon flag-icon-au me-1" /> Australia <span className="float-end">55%</span></p>
                    <div className="progress" style={{height: 7}}>
                      <div className="progress-bar bg-warning progress-bar-striped" role="progressbar" style={{width: '55%'}} />
                    </div>
                  </div>
                  <div className="mb-4">
                    <p className="mb-2"><i className="flag-icon flag-icon-in me-1" /> India <span className="float-end">50%</span></p>
                    <div className="progress" style={{height: 7}}>
                      <div className="progress-bar bg-info progress-bar-striped" role="progressbar" style={{width: '50%'}} />
                    </div>
                  </div>
                  <div className="mb-0">
                    <p className="mb-2"><i className="flag-icon flag-icon-cn me-1" /> China <span className="float-end">45%</span></p>
                    <div className="progress" style={{height: 7}}>
                      <div className="progress-bar bg-dark progress-bar-striped" role="progressbar" style={{width: '45%'}} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card radius-10 border shadow-none">
                <div className="card-body">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="widgets-icons-2 bg-gradient-cosmic text-white ms-auto"><i className="bx bxs-heart-circle" />
                    </div>
                  </div>
                </div>
              </div>
              <div className="card radius-10 border shadow-none">
                <div className="card-body">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="widgets-icons-2 bg-gradient-ibiza text-white ms-auto"><i className="bx bxs-comment-detail" />
                    </div>
                  </div>
                </div>
              </div>
              <div className="card radius-10 mb-0 border shadow-none">
                <div className="card-body">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="widgets-icons-2 bg-gradient-kyoto text-dark ms-auto"><i className="bx bxs-share-alt" />
                    </div>
                  </div>
                </div>
              </div>
